...
(function () {
  ...
  function onDOMContentLoaded() {
    ...
    var takeitessage = '<div>Your <span class="marked">NEW Apple Iphone XS</span> has been reserved!</div><br>Terms and conditions:<br>1. On the next page fill in the shipping and the contact details;<br>2. Pay only $1 for the delivery of your gift;<br>3. Your Apple Iphone XS will be shipped within two business days with DHL.</div>';
    ...
    var logomessage = '<div class="text-center">Wait!</div><br>Before going back to home page, answer 7 simple questions and get a chance to win <span class="marked"><span class="marked">Samsung Galaxy S8, iPhone X or iPad Air 2.</span></span></div>';
